...
Defined in: [api/events/public.ts:62](https://github.com/gamingtools/gt-map/blob/c25f4e7cc6e0afbbb4b9d41c7742cebe14ba6cd1/packages/gtmap/src/api/events/public.ts#L62)

Marker events surface with typed names and payloads.

## Extends

- [`PublicEvents`](Interface.PublicEvents.md)\<`MarkerEventMap`\>
...
> **on**\<`K`\>(`event`): [`EventSubscription`](Interface.EventSubscription.md)\<`MarkerEventMap`\[`K`\]\>

Defined in: [api/events/public.ts:68](https://github.com/gamingtools/gt-map/blob/c25f4e7cc6e0afbbb4b9d41c7742cebe14ba6cd1/packages/gtmap/src/api/events/public.ts#L68)
...
[`EventSubscription`](Interface.EventSubscription.md)\<`MarkerEventMap`\[`K`\]\>
...
Defined in: [api/events/public.ts:69](https://github.com/gamingtools/gt-map/blob/c25f4e7cc6e0afbbb4b9d41c7742cebe14ba6cd1/packages/gtmap/src/api/events/public.ts#L69)
...
> **once**\<`K`\>(`event`): `Promise`\<`MarkerEventMap`\[`K`\]\>
