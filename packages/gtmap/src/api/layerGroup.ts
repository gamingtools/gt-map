...
export class LeafletLayerGroupFacade extends Layer {
  ...
  onRemove(_map: LeafletMapFacade): void {
    ...
    if (this._raf != null) {
      try { (typeof cancelAnimationFrame !== 'undefined') ? cancelAnimationFrame(this._raf as any) : clearTimeout(this._raf as any); } catch {}
      this._raf = null; this._chunkArr = null;
    }
